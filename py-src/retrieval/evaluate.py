...
def evaluate(search_results_file):
    ...
    print 'top-5  precision: %f = %d / %d' % (top_5_precision,  top_5_right,  num_samples * 5)
    print 'top-10 precision: %f = %d / %d' % (top_10_precision, top_10_right, num_samples * 10)
